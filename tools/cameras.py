...
def _radial_and_tangential_undistort(
        ...
        eps: float = 1e-9, max_iterations=10) -> Tuple[np.ndarray, np.ndarray]:
...
class Camera:
    ...
    def from_json(cls, path):
        ...
        return cls(
            ...
            tangential_distortion=np.asarray(camera_json['tangential']),
    ...
    def pixels_to_rays(self,
        ...
        rays_dir = self.orientation.T @ local_rays_dir[..., np.newaxis]
    ...
    def project(self, points: np.ndarray):
        ...
        distortion = 1.0 + r2 * (self.radial_distortion[0] + r2 *
    ...
    def get_pixel_centers(self):
        ...
        return np.moveaxis(np.indices(shape, dtype=self.dtype)[::-1], 0, -1) + 0.5
